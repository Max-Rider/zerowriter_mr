...
class Menu:
    ...
    def display(self):
        ...
        start_index = max(0, self.selected_item - disp_height)  # Start index for display
        ...
        for index in range(start_index, end_index):
            ...
            y_position += 300  # Increment Y position for next menu item
...
class ZeroWriter:
    ...
    def initialize(self):
        ...
        print(self.display.display_dims)
